...
main = do
	putStrLn "Testing ringNew function"
	print $ (ringNew clock :: M.Matrix X8 (Signal Bool))
	putStrLn "Testing ringNew reify"
	debugCircuit [] (ringNew  :: Time -> M.Matrix X8 (Signal Bool))
